...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-card border border-gray-100 bg-white text-gray-950 shadow-elevation-1 transition-all duration-normal hover:shadow-elevation-2 hover:-translate-y-0.5",
      className
    )}
    {...props}
  />
