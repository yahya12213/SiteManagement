...
/**
 * Modal pour déplacer un template vers un autre dossier
 */
      ...
      <div className="bg-white rounded-xl shadow-2xl w-[95vw] sm:w-[450px] md:w-[500px] max-w-[95vw]">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-orange-50 to-orange-100">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold text-gray-900">Déplacer vers un dossier</h2>
          </div>
          <button
            onClick={handleClose}
            disabled={isLoading}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div>
            ...
            <div className="px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-700 flex items-center gap-2">
              ...
              {currentFolder?.name || 'Aucun dossier (racine)'}
            </div>
          </div>
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="flex-1 px-5 py-2.5 bg-gradient-to-r from-orange-600 to-orange-700 text-white rounded-lg hover:from-orange-700 hover:to-orange-800 transition-all shadow-md hover:shadow-lg font-medium disabled:opacity-50 disabled:cursor-not-allowed"
            >
